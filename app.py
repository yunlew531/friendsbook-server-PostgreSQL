...
from api.user import UserAuthApi, UserApi, UserEmail
...
api.add_resource(UserEmail, '/api/user/profile/email/<email>', methods=['POST', 'PATCH', 'DELETE'], endpoint='user_email')
